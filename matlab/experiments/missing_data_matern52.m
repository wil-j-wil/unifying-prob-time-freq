...
verbose = 0; % whether to show optimisation plots
rng('default');
rng(1,'twister');
...
%%
missing_data_results_matern52 = struct;
missing_data_results_matern52.snr_y = snr_y;
missing_data_results_matern52.pesq_y = pesq_y;
missing_data_results_matern52.gaps = gaps;
missing_data_results_matern52.fs = fs;
missing_data_results_matern52.L = L;
missing_data_results_matern52.gapPos = gapPos_for_plot;
missing_data_results_matern52.yTest = yTest;
missing_data_results_matern52.yRecon1 = yRecon1;
missing_data_results_matern52.yRecon2 = yRecon2;
save('../../data/missing_data_results_speech_matern52.mat','missing_data_results_matern52');
