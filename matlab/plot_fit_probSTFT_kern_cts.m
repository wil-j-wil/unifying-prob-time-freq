  function figH = plot_fit_probSTFT_kern_cts(pg,mVar,om,lamx,mVarHist,omHist, ...
				    lamHist,Objs,ObjCur,minVar,kernel,varargin)
...
%   spec = get_pSTFT_spec(freqs,lamx,varx,om);
  spec = specModHandle(freqs,lamx,varx,om);
