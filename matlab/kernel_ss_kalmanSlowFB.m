function  [lik,Xfin,Pfin,varargout] = kernel_ss_kalmanSlowFB(A,Q,C,P0,K, ...
						  vary,y,varargin)

% Will Wilkinson 20181017
%
% Implements the probabilistic filter bank (see Cemgil and Godsill,
% 2005) with A & Q as input. Optionally returns the sufficient statistics
% of the Gaussian LDS. Based on Zoubin Ghahramani and Richard Turner's code.
%
...
%
% function
% [lik,Xfin,Pfin,Ptsum,YX,A1,A2,A3]=kalmanSlowFB(A,Q,om,vary,Y,verbose,KF);
%
% see test_kalmanSlowFB.m for unit tests.
% 
% INPUTS:
% A = state transition matrix [2Dtau,2Dtau] (where tau is the order of the AR model)
