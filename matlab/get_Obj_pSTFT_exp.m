function [Obj,varargout] = get_Obj_pSTFT_exp(theta,vary,specTar,minVar,limOm,limLam,bet);

% Will Wilkinson 20181026
% calculates spectral density and its gradients for the spectral mixture GP
% with exponential kernel function. Based on Richard Turner's original
% code.
